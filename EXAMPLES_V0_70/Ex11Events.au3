...
Global $tFCEHandler
Global $oFCEHandler 
;~ _UIA_Highlight($uia_ouiautomation)

$oFCEHandler=UIA_ObjectFromTag("_MyHandler_", $dtagIUIAutomationFocusChangedEventHandler, $tFCEHandler)

$hr=$UIA_oUIAutomation.AddFocusChangedEventHandler(0, $oFCEHandler())
$running=true
...
$UIA_oUIAutomation.RemoveFocusChangedEventHandler($oFCEHandler())
    consolewrite("Exiting3")
$UIA_oUIAutomation.RemoveAllEventHandlers()
